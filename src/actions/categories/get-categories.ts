...
export async function getCategories(): Promise<Category[]> {
  const categories: Category[] = [
    ...
    // },
    {
      ...
      name: 'Chori-pan',
      description: 'Chorizo tipo argentino, guacamole, queso, chimichurri, aderezo de mayonesa',
      image: 'https://res.cloudinary.com/djq34ckkj/image/upload/v1749682954/placeholder_ugdi4t.webp'
    },
    {
      id: '6d2d8f6f-c5ae-40fb-9145-1c2f0fc321d9',
      name: 'Las Burgers',
      description: '100% Carne de res al carbón, queso manchego, mayonesa, lechuga y cebolla asada',
      image: 'https://res.cloudinary.com/djq34ckkj/image/upload/v1749682954/placeholder_ugdi4t.webp'
    },
    {
